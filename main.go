...
func main(){
	...
	router.HandleFunc("/res/note/{nid:[0-9]{1,9}}/edit/title", EditNoteSetTitleHandler)
	router.HandleFunc("/res/note/{nid:[0-9]{1,9}}/edit/description", EditNoteSetDescriptionHandler)
	router.HandleFunc("/res/note/{nid:[0-9]{1,9}}/edit/text", EditNoteSetTextHandler)
	...
	router.HandleFunc("/res/link/{lid:[0-9]{1,9}}/edit/title", EditLinkSetTitleHandler)
	router.HandleFunc("/res/link/{lid:[0-9]{1,9}}/edit/description", EditLinkSetDescriptionHandler)
	router.HandleFunc("/res/link/{lid:[0-9]{1,9}}/edit/url", EditLinkSetURLHandler)
	router.HandleFunc("/res/link/{lid:[0-9]{1,9}}/edit/toggleFeatured", EditLinkToggleFeaturedHandler)
